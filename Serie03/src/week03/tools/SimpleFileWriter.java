...
public class SimpleFileWriter {
    ...
    public static void main(String[] args) {
        //How to use it:
        SimpleFileWriter writer = new SimpleFileWriter("./filewriter.txt");
        writer.overwrite("Overwrite a file.\n");
        writer.append("Append to a file.\n");
    }

    /**
     * Creates a new file if the file given in the filePath does not exist on construction
     *
